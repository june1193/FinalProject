...
public class MatchRepository {
	...
	/*
	 * int offset = (page - 1) * pageSize; Map<String, Integer> params =
	 * Map.of("offset", offset, "pageSize", pageSize); return
	 * sqlSession.selectList("selectPage", params);
	 */

	// 클럽 조회하기
	public List<Club> selectAll(int page, int pageSize) {
		int offset = (page - 1) * pageSize;
		Map<String, Integer> params = Map.of("offset", offset, "pageSize", pageSize);
		return session.selectList("selectAll", params);
	}
	...
	//검색관련
    public List<Club> searchPosts(String query) {
    	System.out.println(query);
        return session.selectList(namespace + "searchPosts", query);
    }
