            ...
            <c:forEach var="facility" items="${facilities}">
               <div class="swiper-slide">
                  <a href="/racket/facility/${facility.facilityID}">
                     <img src="${facility.image}" alt="${facility.facName}" />
                  ...
                  <div class="post_right">
                     <label class="container"> <input type="checkbox"
                        ...
                        <div class="check_num" id="check_num${post.post_id}"
                           style="font-size: 15px; font-weight: lighter">0</div>
                     </label>
                     <div class="post${post.post_id}_detail">
                        <a href="postDetail.jsp?postId=${post.post_id}">자세히 보기</a>
                     </div>
                  </div>
               </div>
            </div>
