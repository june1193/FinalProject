   ...
   <body>
      ...
      <header>
         <div id="wrap">
            <div class="logo">
               <a href="">
                  <h3><i class="fa-solid fa-table-tennis-paddle-ball"></i> 라켓스포츠 동호회</h3>
               </a>
               <!-- 타이틀 정하기 -->
            </div>
            <nav class="nav">
         ...
         <div class="swiper">
            <div class="swiper-wrapper">
               <div class="swiper-slide">
                  ...
                  <h3>트라이볼</h3>
                  <p>인천문화재단에서 운영하는 송도 트라이볼(tri-bowl)은 각종 공연, 전시, 교육프로그램을 위한 복합문화예술공간입니다.</p>
               </div>
               <div class="swiper-slide">
                  <img src="/img/the BLACK.jpg" alt="" />
                  <h3>the BLACK</h3>
                  <p>
                     the BLACK은 2021년에 설립되어 아티스트와 관객이 함께 호흡하고 즐길 수 있는 공연 문화 공간으로 다양한 장르의 공연 예술을 선보이고 있습니다.
                  </p>
               </div>
               <div class="swiper-slide">
                  <img src="/img/신포아트홀.jpg" alt="" />
                  <h3>신포아트홀</h3>
                  <p>김구 문화의 거리에 위치한 연극 전용공간 입니다. 4층 연습실 사용도 가능한 공간으로 극단 십년후 에서 운영하는 공간입니다.</p>
               </div>
               <div class="swiper-slide">
      ...
      <div class="post_container">
         <div class="post_title">
            ...
            <p style="font-weight: lighter">사용자 여러분들의 평점을 기준으로 한 상위 4개 게시글이에요.</p>
         </div>
         ...
         <div class="post_best">
            <div class="best_post1">
               ...
               <div class="post1_footer">
                  ...
                  <div class="post1_detail"><a href="">자세히 보기</a></div>
               </div>
            </div>
            <div class="best_post2">
               ...
               <div class="post2_footer">
                  ...
                  <div class="post2_detail"><a href="">자세히 보기</a></div>
               </div>
            </div>
            <div class="best_post3">
               ...
               <div class="post3_footer">
                  ...
                  <div class="post3_detail"><a href="">자세히 보기</a></div>
               </div>
            </div>
      ...
      <footer>
         <div class="foot_left">
            <div class="left_title">
               <a href=""><i class="fa-solid fa-table-tennis-paddle-ball" style="font-size: 32px"></i> 라켓스포츠 동호회</a>
            </div>
         </div>
            ...
            <div class="right_title">
               <nav class="right_nav">
                  <ul class="right_list">
                     ...
                     <li><a href="#">커뮤니티</a></li>
                     <li><i class="fa-regular fa-circle-user" style="font-size: 32px; color: #fff"></i></li>
                     <!-- 프로필 AJAX 처리 -->
                  </ul>
               </nav>
            </div>
