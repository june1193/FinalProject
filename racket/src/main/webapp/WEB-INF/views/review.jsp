    ...
    <div id=wrap>
        ...
        <nav>
            ...
            <div class="search-area">
                ...
                <div class="view_controller">
	                <button style="margin-left: auto; margin-right: 5px; background-image: url('/prac/resources/images/글쓰기.png'); background-position: center; background-size: 100% 100%;"></button>
           		  ...
           		  <div class="review_wrap">     
					 	 ...
					 	 <a href="/racket/boarddetail?code=${item.post_id } ">
	                        <div class="post">             
	                            ...
	                            <div>
	                                <img class ="image" src="/prac/resources/images/"> 
	                            </div>
	                            <div>
