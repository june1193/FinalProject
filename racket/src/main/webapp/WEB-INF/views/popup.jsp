...
<script>
	...
	<div class="wrap">
		<input type="hidden" value="${sessionScope.user }" name="uId"/>
        <div class="chatt-wrap">
            <div class="chatt-badminton">
                <a href="javascript:popupOpen('chatting');" title="배드민턴방"><span class="fluent-emoji-high-contrast--badminton"></span></a>
            </div>
